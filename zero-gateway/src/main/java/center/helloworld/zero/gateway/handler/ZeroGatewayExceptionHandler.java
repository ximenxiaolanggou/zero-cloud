package center.helloworld.zero.gateway.handler;
...
@Slf4j
public class ZeroGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public ZeroGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
