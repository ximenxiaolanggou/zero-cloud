package cneter.helloworld.zero.common.constant;

/**
* 系统常量
*/
public interface ZeroConstant {
     ...
     * Gateway请求头TOKEN值
     */
    String GATEWAY_TOKEN_VALUE = "wogua:gateway:123456";
     ...
     * 验证码 key前缀
     */
    String CODE_PREFIX = "wogua.captcha.";

    /**
     * 异步线程池名称
     */
    String ASYNC_POOL = "woguaAsyncThreadPool";
